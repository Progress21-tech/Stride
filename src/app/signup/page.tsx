  ...
  return (
    <div className="max-w-md mx-auto py-10 space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-main)] tracking-tight">Create your Stride Account</h1>
        <p className="text-xs text-[var(--text-muted)]">Join serious tech learners building consistent progress.</p>
      </div>
