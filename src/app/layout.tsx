        ...
        <header class="sticky top-0 z-40 w-full border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur-md">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
              <Link href="/login" class="text-xs font-semibold text-zinc-300 hover:text-white transition flex items-center gap-1 px-2.5 py-1.5 rounded-md hover:bg-zinc-900">
