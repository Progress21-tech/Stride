        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[var(--border-color)] pb-5">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              <div className="text-xs text-[var(--text-muted)]">Daily Deadline</div>
              <div className="text-xs font-mono font-semibold text-[var(--text-main)]">11:59 PM (Local)</div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-2.5">
            {loading && <div className="text-xs text-[var(--text-muted)] py-4 text-center">Loading workspace...</div>}

            {!loading && tasks.length === 0 && (
              <div className="bg-[var(--bg-subtle)] rounded-xl p-6 text-center text-xs text-[var(--text-muted)] border border-[var(--border-color)] space-y-2">
        ...
        <div className="space-y-4">
          <div className="glass-card rounded-xl p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-3">
              ...
              <span className="text-xs text-[var(--text-muted)] font-mono">Qualifying Days</span>
            </div>

            <div className="flex items-baseline justify-between">
              <div>
                <span className="text-4xl font-bold text-[var(--text-main)] tracking-tight">{streak}</span>
                <span className="text-sm text-[var(--text-muted)] ml-1">days streak</span>
              </div>
